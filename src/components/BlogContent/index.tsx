...
const BlogContent = ({
    ...
    return (
        <div
            ...
            className="card cursor-pointer card-compact w-full h-full drop-shadow-sm shadow-black border-2 bg-primary transition-all md:hover:scale-105 duration-300 md:hover:shadow-xl"
        >
